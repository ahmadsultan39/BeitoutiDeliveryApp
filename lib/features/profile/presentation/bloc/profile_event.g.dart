...
class _$SetLogoutValue extends SetLogoutValue {
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('SetLogoutValue').toString();
  }
}
...
class _$GetBalance extends GetBalance {
  ...
  @override
  String toString() {
    return newBuiltValueToStringHelper('GetBalance').toString();
  }
}
...
class _$GetOrdersHistory extends GetOrdersHistory {
  ...
  _$GetOrdersHistory._({required this.page}) : super._() {
    BuiltValueNullFieldError.checkNotNull(page, 'GetOrdersHistory', 'page');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('GetOrdersHistory')..add('page', page))
        .toString();
  }
}
